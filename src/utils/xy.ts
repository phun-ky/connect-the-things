import { ConnectTheThingsCoordinatesInterface } from '../types/xy';
...
export const xy = {
   ...
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the center.
   * @example
   * ```ts
   ...
   * ```
   */
  center: (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the top center.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  top: (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.center_x(rect),
    y: coords.top(rect)
  }),
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the right center.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  right: (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.right(rect),
    y: coords.center_y(rect)
  }),
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the bottom center.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  bottom: (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.center_x(rect),
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the left.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  left: (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.center_y(rect)
  }),
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the right bottom.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'right-bottom': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.right(rect),
    y: coords.bottom(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the left top.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'left-top': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.top(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the left bottom.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'left-bottom': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.bottom(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the top left.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'top-left': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.top(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the top right.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'top-right': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.right(rect),
    y: coords.top(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the bottom left.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'bottom-left': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.bottom(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the bottom right.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'bottom-right': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.right(rect),
    y: coords.bottom(rect)
  }),
  /**
   ...
   * ```
   */
  'top-center': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.center_x(rect),
    y: coords.top(rect)
  }),
  /**
   ...
   * ```
   */
  'right-center': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.right(rect),
    y: coords.center_y(rect)
  }),
  /**
   ...
   * ```
   */
  'bottom-center': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.center_x(rect),
    y: coords.bottom(rect)
  }),
  /**
   ...
   * @param {DOMRect} rect - The DOMRect to retrieve the coordinates from.
   * @returns {ConnectTheThingsCoordinatesInterface} The x and y coordinates of the left center.
   * @example
   * ```ts
   * const rect = element.getBoundingClientRect();
   ...
   * ```
   */
  'left-center': (rect: DOMRect): ConnectTheThingsCoordinatesInterface => ({
    x: coords.left(rect),
    y: coords.center_y(rect)
  })
};
